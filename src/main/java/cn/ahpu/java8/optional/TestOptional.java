package cn.ahpu.java8.optional;
...
public class TestOptional {
    ...
    @Test
    public void test4() {
        Optional<Employee> op = Optional.of(new Employee(101, "张三", 18, 9999.99));//参null 报NullPointerException
    ...
    @Test
    public void test3() {
        //参数为null Employee [id=0, name=张三, age=0, salary=0.0, status=null] 不会报空指针异常
        ...
        Employee emp2 = op.orElseGet(Employee::new);//参数,() -> new Employee()
